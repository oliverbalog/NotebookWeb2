...
--
-- Tábla szerkezet ehhez a táblához `news_rating`
--
...
--
-- Tábla szerkezet ehhez a táblához `notebooks`
--
...
--
-- A tábla adatainak kiíratása `notebooks`
--
...
(3, 'HP', 'COMPAQ 615 NX560EA', '15.6', 2048, 320, 'ATi Mobility Radeon HD3200 256MB', 114800, 1, 4, 1),
...
(247, 'Random', 'Laptop', '15.6', 32, 1024, 'van', 500000, 5, 12, 5);

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `opsystems`
--

CREATE TABLE `opsystems` (
  `id` int(10) UNSIGNED NOT NULL,
  `os_name` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;

--
-- A tábla adatainak kiíratása `opsystems`
--
...
--
-- Tábla szerkezet ehhez a táblához `processors`
--
...
--
-- A tábla adatainak kiíratása `processors`
--
...
--
-- A tábla indexei `news_rating`
--
ALTER TABLE `news_rating`
  ADD PRIMARY KEY (`id`);

--
-- A tábla indexei `notebooks`
--
ALTER TABLE `notebooks`
  ADD PRIMARY KEY (`id`);

--
-- A tábla indexei `opsystems`
--
ALTER TABLE `opsystems`
  ADD PRIMARY KEY (`id`);

--
-- A tábla indexei `processors`
--
...
--
-- AUTO_INCREMENT a táblához `opsystems`
--
ALTER TABLE `opsystems`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT a táblához `processors`
--
ALTER TABLE `processors`
